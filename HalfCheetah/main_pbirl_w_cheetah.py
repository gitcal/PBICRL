import bayesian_irl_w_cheetah_v2
import copy
import IPython
import numpy as np
...
parser.add_argument('--flname', type=str, default='results_cheetah_n_1000_ep_len_8cnstr_50pen')
...
def main():
	...
	with open('data/cheetah_trajectories_cnstr_8_pen_m50.pickle', 'rb') as pickle_file:
	...
	for iters in range(iterations):
		...
		pref_pairs = [good_bad_pairs]

		d12 = []
		d23 = []
		d13 = []
		for ii in range(1):
			birl = bayesian_irl_w_cheetah_v2.BIRL(traj_feat, trajectory_demos_states, pref_pairs, boltz_beta1, boltz_beta2, boltz_beta3,boltz_beta4, N_demonstrations, s, m1, m2, m3, m4, norm_flag)
