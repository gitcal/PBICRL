...
parser.add_argument('--flname', type=str, default='results_fetch_reach')
...
def main():
	...
	for iters in range(iterations):
		...
		d13 = []
		for ii in range(1):
			birl = bayesian_irl_w_rect.BIRL(traj_feat, trajectory_demos_states, pref_pairs, boltz_beta1, boltz_beta2, boltz_beta3,boltz_beta4, N_demonstrations, s, m1, m2, m3, m4, norm_flag)
			...
			res_dict[iters,'mean_cnstr'] = chain_constraints[-500:,:]
